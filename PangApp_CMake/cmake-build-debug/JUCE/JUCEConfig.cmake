...
if(NOT TARGET juce::juceaide)
    ...
    set_target_properties(juce::juceaide PROPERTIES
        IMPORTED_LOCATION "${PACKAGE_PREFIX_DIR}/bin/JUCE-6.1.2/juceaide.exe")
endif()
...
include("${PACKAGE_PREFIX_DIR}/lib/cmake/JUCE-6.1.2/JUCEModuleSupport.cmake")
include("${PACKAGE_PREFIX_DIR}/lib/cmake/JUCE-6.1.2/JUCEUtils.cmake")
